...
3. Add the tool definition to `mcp/tools/{module}.ts` in the appropriate tools array
4. Add the handler case in `mcp/handlers/{module}.ts` in the handleTool function
